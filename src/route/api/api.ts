...
import admin_cron_PUT from './admin/cron_PUT';
import admin_cronLog from './admin/cronLog';
...
router.put('/admin/cron/:task', admin_cron_PUT);
router.get('/admin/cronLog', admin_cronLog);
