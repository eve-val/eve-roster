...
import { MKT_GROUP_PIRATE_CRUISERS, MKT_GROUP_NAVY_FRIGATES, MKT_GROUP_NAVY_BATTLECRUISERS, MKT_GROUP_PIRATE_FRIGATES, MKT_GROUP_NAVY_CRUISERS, MKT_GROUP_PIRATE_BATTLESHIPS, MKT_GROUPS_T1_FRIGATES, MKT_GROUPS_T1_CRUISERS, MKT_GROUPS_T1_DESTROYERS } from '../../eve/constants/marketGroups';
...
const PIRATE_FRIGATES: TemplateRule = {
  filter: { marketGroupId: [MKT_GROUP_PIRATE_FRIGATES] },
  verdicts: [{
    status: SrpVerdictStatus.APPROVED,
...
const PIRATE_CRUISERS: TemplateRule = {
  filter: { marketGroupId: [MKT_GROUP_PIRATE_CRUISERS] },
  verdicts: [
    {
      status: SrpVerdictStatus.APPROVED,
...
const PIRATE_BATTLESHIPS: TemplateRule = {
  filter: { marketGroupId: [MKT_GROUP_PIRATE_BATTLESHIPS] },
  verdicts: [{
    status: SrpVerdictStatus.APPROVED,
