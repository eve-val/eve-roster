    ...
    return trx('privilege')
        .insert([
          ...
          },
          {
            ...
            requiresMembership: true,
            description:
                `A character's logon/logoff/kills/losses/scanning stats.`,
          },
          {
          ...
          },
          {
            ...
            requiresMembership: true,
            description:
                `Whether an external character is opsec" (see memberOpsecAlts)."`,
          },
          {
            name: 'serverLogs',
            category: 'admin',
  ...
  .then(() => {
    return trx('config')
        .insert([{
          key: 'siggyUsername',
          value: null,
          description: 'Siggy account username to use when scraping Siggy stats.',
        }, {
          key: 'siggyPassword',
          value: null,
          description: 'Siggy account password to use when scraping Siggy stats.',
        }]);
  })
};
